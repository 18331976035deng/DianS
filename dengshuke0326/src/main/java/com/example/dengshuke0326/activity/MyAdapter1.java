...
public class MyAdapter1 extends BaseAdapter {
    Context context;
    List<Bean.ResultBean.MlssBean.CommodityListBeanXX> commodityList;

    public MyAdapter1(Context context, List<Bean.ResultBean.MlssBean.CommodityListBeanXX> commodityList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bean.ResultBean.MlssBean.CommodityListBeanXX commodityListBeanXX = commodityList.get(position);
